    ...
    return (
        ...
        >
            <Box sx={{maxWidth: "560px"}}>
                ...
                <Typography sx={{color: "#fff"}}> Stay informed with real-time data on cryptocurrency prices, market trends, and portfolio performance. Track your favorite cryptocurrencies,explore market insights, and make informed decisions—all in one convenient place. </Typography>
            </Box>
